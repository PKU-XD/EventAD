...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_path", type=Path, default="/home/handsomexd/EventAD/data/detector/ROL/train/1_M/events/left/events.h5", help="Path to input events.h5. ")
    parser.add_argument("--output_path", type=Path, default="/home/handsomexd/EventAD/data/detector/ROL/train/1_M/events/left/events_2x.h5", help="Path where output events.h5 will be written.")
    parser.add_argument("--input_height", type=int, default=720, help="Height of the input events resolution.")
    parser.add_argument("--input_width", type=int, default=1080, help="Width of the input events resolution")
    parser.add_argument("--output_height", type=int, default=240, help="Height of the output events resolution.")
    parser.add_argument("--output_width", type=int, default=360, help="Width of the output events resolution.")
    args = parser.parse_args()

    num_events = get_num_events(args.input_path)
    num_events_per_chunk = 1500000
    if num_events < 20000000:
        num_events_per_chunk = 100000
    elif num_events < 40000000:
        num_events_per_chunk = 200000
    elif num_events < 60000000:
        num_events_per_chunk = 400000
    elif num_events < 80000000:
        num_events_per_chunk = 600000
    elif num_events < 100000000:
        num_events_per_chunk = 1000000
